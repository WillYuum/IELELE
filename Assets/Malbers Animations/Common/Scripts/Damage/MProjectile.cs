...
namespace MalbersAnimations.Weapons
{
    ...
    public class MProjectile : MDamager, IProjectile
    {
        ...
        private void Start()
        {
            ...
            m_collider = GetComponentInChildren<Collider>(); //it was activating the collider on the Bow
        }
    ...
    public class MProjectileEditor : MDamagerEd
    {
        SerializedProperty gravity, Penetration, /*InstantiateOnImpact,*/ PushMultiplier, Editor_Tabs1, KeepDamageValues,
            Life, LifeImpact,
            OnFire, impactBehaviour, rotation, torque, torqueAxis, m_PosOffset, m_RotOffset;
