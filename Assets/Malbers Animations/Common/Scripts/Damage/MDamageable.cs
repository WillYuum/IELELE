...
namespace MalbersAnimations
{
    ...
    public class MDamageable : MonoBehaviour, IMDamage
    {
        ...
        public BoolReference AlingToDamage = new BoolReference(false);
    ...
    {
        SerializedProperty reaction, stats, multiplier, events, Root, AlignTime, AlignCurve, AlingToDamage, Editor_Tabs1;
        MDamageable M;
        ...
        private void OnEnable()
        {
            ...
            AlingToDamage = serializedObject.FindProperty("AlingToDamage");
        ...
        private void DrawGeneral()
        {
            ...
            using (new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                EditorGUILayout.PropertyField(AlingToDamage);

                if (M.AlingToDamage.Value)
                {
