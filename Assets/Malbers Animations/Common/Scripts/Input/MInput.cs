    ...
    public class MInput : MonoBehaviour, IInputSource , IAnimatorListener
    {
       ...
       // public Dictionary<string, InputRow> DInputs = new Dictionary<string, InputRow>();        //Shame it cannot be Serialided :(
        ...
        private void DisableAllInputs()
        {
            ...
            foreach (var acMap in actionMaps)
                foreach (var inp in acMap.inputs)
                    inp.active.Value = false;
        ...
        {
            inputs.Add(new InputRow(true, "MainAttack", "Fire1", KeyCode.Mouse0, InputButton.Press, InputType.Key));
            MTools.SetDirty(this);
        }
        ...
        {
            inputs.Add(new InputRow(true, "SecondAttack", "Fire2", KeyCode.Mouse1, InputButton.Press, InputType.Key));
            MTools.SetDirty(this);
        }
